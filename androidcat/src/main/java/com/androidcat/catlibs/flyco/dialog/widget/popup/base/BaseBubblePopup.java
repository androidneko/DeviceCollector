package com.androidcat.catlibs.flyco.dialog.widget.popup.base;
...
import com.androidcat.catlibs.flyco.animation.BounceEnter.BounceLeftEnter;
import com.androidcat.catlibs.flyco.animation.FadeExit.FadeExit;
import com.androidcat.catlibs.flyco.dialog.utils.CornerUtils;
import com.androidcat.catlibs.flyco.dialog.utils.StatusBarUtils;
import com.androidcat.catlibs.flyco.dialog.view.TriangleView;
import com.androidcat.catlibs.flyco.dialog.widget.internal.InternalBasePopup;
...
public abstract class BaseBubblePopup<T extends BaseBubblePopup<T>> extends InternalBasePopup<T> {
    ...
    public View onCreateView() {
        View inflate = View.inflate(mContext, Res.layout(getContext(),"whty_traffic_popup_bubble"), null);
        mLlContent = inflate.findViewById(Res.id(getContext(),"ll_content"));
        mTriangleView = inflate.findViewById(Res.id(getContext(),"triangle_view"));
