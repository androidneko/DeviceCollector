 ...
 */
package com.androidcat.catlibs.permission;
...
import com.androidcat.catlibs.permission.target.AppActivityTarget;
import com.androidcat.catlibs.permission.target.AppFragmentTarget;
import com.androidcat.catlibs.permission.target.ContextTarget;
import com.androidcat.catlibs.permission.target.SupportFragmentTarget;
...
//            if (result == AppOpsManagerCompat.MODE_IGNORED) return false;
    ...
    public static
    @NonNull
    RationaleCustomDialog rationaleCustomDialog(@NonNull Context context, Rationale rationale) {
        return new RationaleCustomDialog(context, rationale);
    }
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull androidx.fragment.app.Fragment fragment, int requestCode) {
    ...
    public static
    @NonNull
    SettingService defineSettingDialog(@NonNull androidx.fragment.app.Fragment fragment, int requestCode) {
    ...
    public static
    @NonNull
    Request with(@NonNull androidx.fragment.app.Fragment fragment) {
